    ...
    <div class="page-login">
        ...
        <div class="login-panel">
            ...
            <div class="form">
                ...
                <el-input :class="{error:error && ! userName}" v-model="userName" placeholder="手机/用户名/密码" prefix-icon="profile"></el-input>
        ...
        <footer>
            ...
            <p>©2019 美团网团购 meituan.com 京ICP证070791号 京公网安备11010502025545</p>
        </footer>
    </div>
</template>
<script>
